...
import GrokAdapter from './automations/mode6/agents/grok-adapter';
import ClaudeAdapter from './automations/mode6/agents/claude-adapter';
import OpenAIAdapter from './automations/mode6/agents/openai-adapter';
import { AdapterRegistry } from './automations/mode6/agents/adapter-registry';
