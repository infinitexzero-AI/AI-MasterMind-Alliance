                        ...
                        <div className="bg-slate-900/60 rounded-2xl border border-white/5 shadow-sm p-6 flex flex-col">
                           <div className="flex items-center justify-between mb-5">
                            ...
                            <div className="space-y-3">
                                {agents.map((agent) => (
                                    <div key={agent.name} className="bg-slate-800/80 rounded-xl p-4 flex flex-col gap-3 border border-white/5 hover:border-white/10 transition-colors">
                                            ...
                                            <div className="flex gap-2 items-center">
                                                {agent.name === 'COMET' && (
                                                    <button
                                                        ...
                                                        className="p-1 hover:bg-cyan-500/20 rounded text-cyan-500 transition-colors"
                                                ...
                                                <span className={`px-2 py-0.5 rounded text-[9px] font-bold uppercase ${agent.status === 'online' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-slate-800 text-slate-500'}`}>
                                                    {agent.status}
                                                </span>
                                            </div>
                                        </div>
