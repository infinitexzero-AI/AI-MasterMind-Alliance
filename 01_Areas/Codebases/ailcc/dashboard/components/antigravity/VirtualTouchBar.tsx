...
import { Play, RefreshCw, Hammer, Smartphone, Terminal, Zap } from 'lucide-react';
...
export const VirtualTouchBar: React.FC<VirtualTouchBarProps> = ({ onAction }) => {
  const buttons = [
    ...
    { id: 'comet', label: 'DELEGATE', icon: <Zap size={16} />, color: 'bg-indigo-500/20 text-indigo-400 border-indigo-500/50' },
