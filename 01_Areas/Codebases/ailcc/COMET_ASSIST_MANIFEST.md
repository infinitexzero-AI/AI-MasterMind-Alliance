...
### 1. Browser Assistant (Comet)

- **Role:** Web Research, GitHub Management, API Coordination, Web App Testing.
- **Tools:** Browser DOM Access, Linear API, Perplexity API.
- **Focus:** External World (Internet/SaaS).

### 2. Desktop Engine (Antigravity)

- **Role:** Code Generation, File Operations, Git Operations, Local Execution.
- **Tools:** File System, Terminal, Python/Node Runtimes, Local LLMs.
- **Focus:** Internal World (Local Machine/Codebase).

### 3. Neural Bridge (Corpus Callosum)

- **Role:** Synchronization & Handoff.
- **Mechanism:** WebSocket (Port 3001) + Shared `credentials.env`.
- **Workflow:**
    1.  Comet plans task ->
    2.  Writes to `task.md` ->
    3.  Triggers Antigravity via Bridge ->
    4.  Antigravity executes ->
    5.  Antigravity updates `task.md` ->
    6.  Comet verifies.

## VI. Implementation Roadmap

### Phase 1: Integration & Sync (Current)

- [x] Establish bidirectional WebSocket bridge.
- [x] Verify `antigravity_bridge.py` communication.
- [x] Visualize "Gemini Status" in Dashboard.

### Phase 2: Automation & Delegation

- [ ] Enable Comet to trigger `git commit` via Antigravity.
- [ ] Connect Real LLM APIs (OpenAI/Anthropic) to Orchestration Engine.
- [ ] Implement "Agent Registry" for dynamic swarm visualization.
- [ ] Create "Collaboration Mission" to test multi-agent handoffs.
