...
| Period | Event / Milestone | Evidence Context |
| :--- | :--- | :--- |
| **2016** | **The Origin**: Enrollment via Labour/PETL funding project. | Initial funding agreements. |
| **2018-19** | **Core Success**: Passed CHEM 1001 (C) and BIOL 2811 (C-). | Proves academic capability. |
| **Oct 2022** | **Proactive Planning**: Inquiry into full-time vs. part-time status. | Disability alignment. |
| **Winter 2023** | **The Derailment**: Personal/Medical issues leading to failure. | Internal/External stressors. |
| **Oct 2023** | **Good-Faith Action**: Attempt to withdraw was blocked by institutional holds. | **Critical Procedural Block.** |
| **Fall 2025** | **The Recovery**: Current progress in COMM 3611, VMCS 1201, INDG 2881. | 95% Degree completion. |
