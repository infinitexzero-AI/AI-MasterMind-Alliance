# Post-Undergraduate Strategic Roadmap

**Joel Alfred Palk-Ricard**  
**Mature Student Profile | Permanent Disability | Low-Income Support Needs**  
**Primary Targets:** Dalhousie University MD (Widening Accessibility Stream) & MSc Psychology & Neuroscience  
**Target Start Window:** Fall 2027 – Fall 2028  
**Report Date:** April 29, 2026  

---

## Phase 0: Core Strategic Mindset

Your greatest advantage lies in structural holistic review frameworks. The **Dalhousie Widening Accessibility Stream** explicitly protects candidates overcoming persistent systemic hurdles. Your real-world resilience (successful self-employment benchmarks + smart contract implementation) completely offsets lower legacy GPAs.
...
- **Disability/Low-Income Pipeline Setup:**
  - File non-repayable allocation protocols via New Brunswick Student Financial Assistance (`studentaid.gnb.ca`).
  - Secure the **Canada Student Grant for Students with Permanent Disabilities** (~$2,800/year) alongside the equipment support block (~up to $8,000/year).
- **Academic Preparation:** Initiate standard CARS mapping routines for upcoming medical testing blocks.
