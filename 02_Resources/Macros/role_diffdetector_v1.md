---
workflow_name: role_diffdetector_v1
version: v1
created: 2025-12-16
updated: 2025-12-16
author: Comet/System
...
# Macro: The DiffDetector

## Objective
Capture state T0 -> wait -> capture state T1 -> diff -> report changes.
...
### Step 1: [Action Name]
**Tool**: `browser`
**Action**: Initialize DiffDetector protocols
**Output**: Ready state
